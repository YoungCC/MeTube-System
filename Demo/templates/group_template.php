                  ...
                  $topic = $group["topic"];
                    ...
                    <a href="#" class="list-group-item">
                        ...
                        <div class="list-group-item-text">
                            <button onclick="document.location.href = '../public/topic.php?groupid=$groupid&groupname=$groupname&topic=$topic'" class="btn btn-primary btn-primary" type="button" align="left">Join</button>
                        </div>
                    </a>
_END;
                }  
