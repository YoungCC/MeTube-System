		...
		<div class="col-sm-6 col-md-6 col-lg-6">
			...
			<!-- artigo em destaque -->
			 <div class="featured-article">
				<a href="#">
					<img src="../templates/images/audio.jpg" alt="" class="thumb" style='height: 100%; width: 100%; object-fit: contain'>
<audio controls>
...
<div class="img-thumbnail"><img src="../templates/images/audio.jpg" alt="Thumbnail Image 1" class="img-responsive" width="100" height="100"></div>			    </a>
