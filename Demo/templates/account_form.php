...
<div class="container">
    ...
    <div class="btn-pref btn-group btn-group-justified btn-group-lg" role="group" aria-label="...">
		...
		<h4>Confirm  Password:</h4><input type="password" class="form-control" name="password1" placeholder="Repeat Password if need to change" >
		<h4>Email:</h4><input type="email" class="form-control" name="email" required>
